...
class ExperimentService:
    ...
    _KEYWORDS = {
        ...
        "E010": ("炉顶煤气组成", "理论炉顶气", "top gas composition"),
        "E012": ("风口前煤气", "风口煤气量", "理论煤气量"),
        "E013": ("回旋区绝热火焰温度", "风口火焰温度", "raft"),
        "E106": ("完整rist", "rist理想点", "直接还原度"),
        "E109": ("完整喷煤置换", "pci边际收益", "结构焦比"),
        "E014": ("ergun", "料柱压降", "填充床压降"),
        "E015": ("高炉透气性", "透气阻力", "透气性指数", "料柱阻力指数"),
        "E020": ("高炉碳足迹", "高炉排放", "活动数据排放", "tco2e/thm"),
        "E021": ("boudouard", "布德瓦反应", "碳溶反应", "co/co2平衡", "平衡驱动力"),
        "F008": ("二冷总水量", "比水量", "二次冷却水量", "连铸冷却水"),
        "F009": ("二冷分区", "分区配水", "二冷水量分配", "冷却区水量"),
        "F011": ("拉速优化", "最大可行拉速", "连铸拉速", "拉坯速度约束"),
        "F014": ("铸坯热应力", "热应变", "分层热应力", "连铸应力"),
        "F018": ("夹杂上浮", "夹杂物上浮时间", "终端上浮速度", "inclusion flotation"),
        "G001": ("网格尺度", "网格加密", "gci", "网格收敛"),
        "G002": ("cfl", "时间步稳定", "fourier数", "显式稳定性"),
        "G003": ("一维导热pde", "瞬态导热场", "有限体积导热", "heat pde"),
        "G004": ("反应ode", "反应动力学求解", "质量作用反应", "solve ivp"),
        "G008": ("规则网格插值", "查找表", "一维查表", "二维查表", "双线性插值"),
        "G009": ("局部敏感性", "中心差分", "参数敏感度", "敏感性排序"),
        "G010": ("蒙特卡洛不确定度", "不确定度传播", "失效概率", "相关采样"),
        "G005": ("openfoam案例", "laplacianfoam", "参数化导热案例", "openfoam网格"),
        "G006": ("参数化批处理", "参数网格", "批量仿真", "笛卡尔参数"),
        "G011": ("贝叶斯优化", "高斯过程优化", "expected improvement", "期望改进"),
        "G012": ("多目标优化", "nsga-ii", "pareto", "帕累托"),
        "G013": ("约束规则", "规则校验", "约束检查", "质量闭合规则"),
        "E022": ("铁氧化物逐级还原", "还原平衡", "fe2o3还原", "co还原平衡", "h2还原平衡"),
        "H001": ("钢液脱氧平衡", "铝脱氧", "硅脱氧", "锰脱氧", "wagner活度"),
    }
