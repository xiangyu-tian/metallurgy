...
class ModelRegistry:
    ...
    def discover(self, package_name: str = "models_core") -> int:
        ...
        for module_name in [
            ...
            f"{package_prefix}.models_a_w12",
            f"{package_prefix}.models_b",
            f"{package_prefix}.models_b_p1",
            f"{package_prefix}.models_b_w11",
            f"{package_prefix}.models_b_w12",
            f"{package_prefix}.models_c",
            f"{package_prefix}.models_c_w9",
            f"{package_prefix}.models_c_w10",
            f"{package_prefix}.models_c_w11",
            f"{package_prefix}.models_c_w13",
            ...
            f"{package_prefix}.models_d_w11",
            f"{package_prefix}.models_d_w13",
            ...
            f"{package_prefix}.models_w16",
            f"{package_prefix}.models_w17",
            f"{package_prefix}.models_g_w18",
            f"{package_prefix}.models_eh_w18",
        ]:
            try:
