...
class R0DataEligibilityAndLlmToolTests(unittest.TestCase):
    ...
    def test_four_dimensional_counts_are_dynamic(self):
        ...
        self.assertEqual(counts["registered_count"], 34)
        self.assertEqual(counts["implementation_qualified_count"], 34)
        self.assertEqual(counts["qualified_executable_count"], 34)
        self.assertEqual(counts["data_required_count"], 14)
        self.assertEqual(counts["data_qualified_count"], 14)
        self.assertEqual(counts["interface_qualified_count"], 34)
        self.assertEqual(counts["fully_eligible_count"], 34)
    ...
    def test_http_contract_lists_and_calls_only_fully_eligible_tools(self):
        ...
        self.assertEqual(manifest["total"], 34)
        self.assertEqual(manifest["fully_eligible_count"], 34)
