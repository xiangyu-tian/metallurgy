...
class R0DataEligibilityAndLlmToolTests(unittest.TestCase):
    ...
    def test_four_dimensional_counts_are_dynamic(self):
        ...
        self.assertEqual(counts["registered_count"], 45)
        self.assertEqual(counts["implementation_qualified_count"], 45)
        self.assertEqual(counts["qualified_executable_count"], 45)
        self.assertEqual(counts["data_required_count"], 21)
        self.assertEqual(counts["data_qualified_count"], 21)
        self.assertEqual(counts["interface_qualified_count"], 45)
        self.assertEqual(counts["fully_eligible_count"], 45)
    ...
    def test_http_contract_lists_and_calls_only_fully_eligible_tools(self):
        ...
        self.assertEqual(manifest["fully_eligible_count"], 45)
