...
DATA_REQUIRED_IDS = {
    ...
    "D001", "D002", "D005", "D010", "D011", "D012", "D013", "D014", "E003", "E004",
...
class R0DataEligibilityAndLlmToolTests(unittest.TestCase):
    ...
    def test_four_dimensional_counts_are_dynamic(self):
        ...
        self.assertEqual(counts["registered_count"], 60)
        self.assertEqual(counts["implementation_qualified_count"], 60)
        self.assertEqual(counts["qualified_executable_count"], 60)
        self.assertEqual(counts["data_required_count"], 29)
        self.assertEqual(counts["data_qualified_count"], 29)
        self.assertEqual(counts["interface_qualified_count"], 60)
        self.assertEqual(counts["fully_eligible_count"], 60)
    ...
    def test_http_contract_lists_and_calls_only_fully_eligible_tools(self):
        ...
        self.assertEqual(manifest["total"], 60)
        self.assertEqual(manifest["fully_eligible_count"], 60)
