"""Contract tests for preserving 53 runtime assets while using the workbook as catalog."""
...
class ToolCatalogCrosswalkTests(unittest.TestCase):
    ...
    def test_all_current_runtime_assets_are_preserved_once(self):
        ...
        self.assertEqual(len(mapped), 53)
    ...
    def test_registry_exposes_dual_identity_and_dual_counts(self):
        ...
        self.assertEqual(counts["runtime_tool_count"], 53)
        self.assertEqual(counts["catalog_coverage_count"], 49)
