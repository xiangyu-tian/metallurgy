"""Contract tests for preserving 60 runtime assets while using the workbook as catalog."""
...
class ToolCatalogCrosswalkTests(unittest.TestCase):
    ...
    def test_registry_exposes_dual_identity_and_dual_counts(self):
        ...
        self.assertEqual(counts["runtime_tool_count"], 60)
        self.assertEqual(counts["catalog_coverage_count"], 56)
