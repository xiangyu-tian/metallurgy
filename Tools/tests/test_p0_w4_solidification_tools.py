...
class P0W4SolidificationTests(unittest.TestCase):
    ...
    def test_w4_tools_remain_qualified_after_w5a(self):
        ...
        self.assertEqual(self.registry.get_counts(), {
            "registered_count": 97, "runtime_tool_count": 97, "catalog_coverage_count": 79,
            "qualified_executable_count": 97, "implementation_qualified_count": 97,
            "data_required_count": 33, "data_qualified_count": 33,
            "interface_qualified_count": 97, "fully_eligible_count": 97,
        })
