...
class P0W4SolidificationTests(unittest.TestCase):
    ...
    def test_w4_tools_remain_qualified_after_w5a(self):
        ...
        self.assertEqual(self.registry.get_counts(), {
            "registered_count": 109, "runtime_tool_count": 109, "catalog_coverage_count": 91,
            "qualified_executable_count": 109, "implementation_qualified_count": 109,
            "data_required_count": 35, "data_qualified_count": 35,
            "interface_qualified_count": 109, "fully_eligible_count": 109,
        })
