...
class P0W4SolidificationTests(unittest.TestCase):
    ...
    def test_w4_tools_remain_qualified_after_w5a(self):
        ...
        self.assertEqual(self.registry.get_counts(), {
            "registered_count": 120, "runtime_tool_count": 120, "catalog_coverage_count": 100,
            "qualified_executable_count": 120, "implementation_qualified_count": 120,
            "data_required_count": 37, "data_qualified_count": 37,
            "interface_qualified_count": 120, "fully_eligible_count": 120,
        })
