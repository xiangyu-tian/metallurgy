...
class P0W4SolidificationTests(unittest.TestCase):
    ...
    def test_w4_tools_remain_qualified_after_w5a(self):
        ...
        self.assertEqual(self.registry.get_counts(), {
            "registered_count": 60, "runtime_tool_count": 60, "catalog_coverage_count": 56,
            "qualified_executable_count": 60, "implementation_qualified_count": 60,
            "data_required_count": 29, "data_qualified_count": 29,
            "interface_qualified_count": 60, "fully_eligible_count": 60,
        })
